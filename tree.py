...
def draw_1():
    ...
    turtle.goto(-250, 0)
    turtle.color('red')
    write = turtle.write('anan 宝贝 ~~', font=('宋体', 60, 'normal'))
    time.sleep(2)
...
def draw_3():
    ...
    turtle.goto(-220, 50)
    turtle.color('red')
    write = turtle.write('爱你', font=('宋体', 60, 'normal'))
    turtle.penup()
    turtle.goto(0, -50)
    write = turtle.write('爱你', font=('宋体', 60, 'normal'))
    turtle.penup()
...
def draw_4():
    ...
    turtle.color('blue')
    turtle.pendown()
    turtle.write('bobo      anan', font=('wisdom', 50, 'normal'))
    turtle.speed(1)
    turtle.penup()
    turtle.color("red")
    turtle.goto(-31, -200)
...
def love(x,y):#在(x,y)处画爱心lalala
    ...
    curvemove()
    lv.forward(22)
    lv.write("bobo love anan",font=("Arial",12,"normal"),align="center")
    lv.left(140)#画完复位
    lv.end_fill()
...
if __name__ == '__main__':
    turtle.setup(900, 650)     #调画布的尺寸
    turtle.Screen().title('To: anan darling ...')
    for i in number:
        draw_0(i)
        clear_screen()
    draw_1()
    ...
    tree(100,t)
    t.goto(300, -200)
    t.write("2021.02",font=("Arial",15,"normal"))
    myWin.exitonclick()
